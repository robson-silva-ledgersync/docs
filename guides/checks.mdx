...
<Steps>
  <Step title="Connect Ledgersync Bank">
    Follow the FDE walkthrough in [Testing in sandbox](/guides/testing). It accepts any username and password.
  </Step>
...
<Card title="Full reference" icon="code" href="/api-reference">
  Every parameter and response field for the three check routes, under **Checks**.
</Card>
