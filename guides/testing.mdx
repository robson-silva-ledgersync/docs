...
| --- | --- | --- |
| `connection.requires_action` | Immediately after `POST /v3/clients/{id}/connections`. | Always fires first. Payload carries `data.action.widget_url` — open it for the end-user. |
