...
<CardGroup cols={2}>
  <Card title="Build with an AI assistant" icon="wand-magic-sparkles" href="/guides/build-with-ai">
    One brief to paste into Claude or ChatGPT, plus the steps only you can do.
  </Card>
